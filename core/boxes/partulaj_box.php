 ...
 */
class partulajbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "partulaj@partulaj";
    public $boxlabel;
    public $depends = array("partulaj");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/partulaj/class/partulaj.class.php";
